...
public class HisPushWenZhouYiYuanOnWorker extends HisBasePushOnWorker {

	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushWenZhouYiYuanOnWorker.class);

	@Override
	public String versionName() {
		return String.valueOf("温州一院对接");
	}
