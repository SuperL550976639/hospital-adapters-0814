...
public class DeleteUserResponse  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6334136218820808273L;
	private boolean deleteUserResult;
	...
	public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            this.deleteUserResult == other.isDeleteUserResult();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += (isDeleteUserResult() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">DeleteUserResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("deleteUserResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "DeleteUserResult"));
